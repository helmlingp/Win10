...
$DestinationURL = "start.auspost.com.au"
$DestinationOGName = "apcorp"
$Username = "Staging@AustraliaPost.com"
$Password = "y:M3O_"
...
Function Enroll-Device {
    ...
    Try {
        Start-Process msiexec.exe -Wait -ArgumentList "/i $current_path\AirwatchAgent.msi /quiet /log $current_path\AWAgent.log ENROLL=Y IMAGE=N SERVER=$DestinationURL LGNAME=$DestinationOGName USERNAME=$Username PASSWORD=$Password DOWNLOADWSBUNDLE=false"
	} catch {
